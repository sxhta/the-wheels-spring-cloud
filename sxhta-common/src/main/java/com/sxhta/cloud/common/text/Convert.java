...
public final class Convert implements Serializable {
    ...
    public static Character toChar(Object value, Character defaultValue) {
        ...
        final var valueStr = toStr(value, null);
    ...
    public static Long[] toLongArray(String split, String str) {
        ...
        final var arr = str.split(split);
        final var longs = new Long[arr.length];
        for (Integer i = 0; i < arr.length; i++) {
            final var v = toLong(arr[i], null);
            longs[i] = v;
        }
        return longs;
    }
    ...
    public static String digitUppercase(double n) {
        ...
        var integerPart = (int) Math.floor(n);
